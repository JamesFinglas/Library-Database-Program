...
/**
 * This is a table builder for searching transactions by member Id
 * @author Cathal Murphy & James Finglas
 */
public class TransactionsByMemberId extends JPanel
{
	
	private boolean isResultSetEmpty= false;
	private int id = sixTransactionsPanel.builderInstance.getMemberId();
	JTable table;

	/**
	 * This method is the table constructor
	 */
	public TransactionsByMemberId()
	{
	...
	public  Object[][] transactionsData() throws ClassNotFoundException, SQLException
	{
		...
		String strSelect = "select * from transactions WHERE member_Id = " + id;
