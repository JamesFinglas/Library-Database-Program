...
/**
 * This is a table builder for searching users by name
 * @author Cathal Murphy & James Finglas
 */
public class UsersByName extends JPanel
{
	
	private static boolean isResultSetEmpty = false;
	private String username = threeUsersPanel.instance.getUsername();
	JTable table;
		...
		public UsersByName()
		{
			...
			JPanel tableContainer = new JPanel(new GridLayout());
				...
				try
				{
					...
					Object[][] data = userDataById(username);
					gaurd = 1;
		 ...
		 * @throws SQLException
		 */
		public static Object[][] userDataById(String username) throws ClassNotFoundException, SQLException
		{
