...
/**
 * This is a table builder for searching books by Publisher
 * @author Cathal Murphy & James Finglas
 */
public class BooksByPublisher extends JPanel
{
	
	private boolean isResultSetEmpty = false;
	private String publisher = fourBooksPanel.bookInstance.getPublisher();
	JTable table;
	...
	public  Object[][] booksData() throws ClassNotFoundException, SQLException
	{
		...
		String strSelect = "select * from Books WHERE publisher =" + "'" + publisher + "'" ;
