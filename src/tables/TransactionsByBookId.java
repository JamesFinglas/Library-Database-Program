...
/**
 * This is a table builder for searching transactions by book Id
 * @author Cathal Murphy & James Finglas
 */
public class TransactionsByBookId extends JPanel
{
	
	private boolean isResultSetEmpty = false;
	private int id = sixTransactionsPanel.builderInstance.getBookId();
	JTable table;

	/**
	 * This method is the table constructor
	 */
	public TransactionsByBookId()
	{
